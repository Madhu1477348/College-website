          ...
          <div className="gradient-primary text-white rounded-2xl shadow-xl p-8 md:p-12 mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {techStack.map((tech, index) => (
                <div
                  key={index}
                  className="bg-gray bg-opacity-20 backdrop-blur-sm rounded-lg p-4 text-center font-semibold hover:bg-opacity-30 transition-all duration-300 transform hover:scale-105 border border-white border-opacity-30"
                >
                  {tech}
                </div>
              ))}
